...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final String KEY_YUANWEIOS_VERSION = "yuanweios_version";
    private static final String KEY_YUANWEIOS_BUILD_DATE = "build_date";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_YUANWEIOS_VERSION, "ro.yuanweios.version");
        setValueSummary(KEY_YUANWEIOS_BUILD_DATE, "ro.build.date");
